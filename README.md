...
Plateforme web d'apprentissage de la langue Dendi — pour préserver et transmettre une langue du nord du Bénin à l'ère numérique.
...
🧠 Mode quiz pour tester ses connaissances
👤 Authentification utilisateur
📈 Suivi de progression personnalisé
🌙 Thème clair / sombre

🛠️ Stack technique
CoucheTechnologieFrontendNext.js + TypeScriptBase de donnéesSupabase (PostgreSQL)AuthSupabase AuthDéploiementVercel
🚀 Lancer le projet
bashgit clone https://github.com/GhostDRAKEN/dendi-learn
cd dendi-learn
npm install
npm run dev
